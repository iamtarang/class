...
class _TeacherPageState extends State<TeacherPage> {
  ...
  String abc = emailController.text;
                  ...
                  child: Form(
                      ...
                      child: Column(children: <Widget>[
                          ...
                          Theme(
                            data: ThemeData(
                              unselectedWidgetColor:
                                  Color(0xFF6F35A5), // Change the color here
                            ),
                            child: Checkbox(
                              activeColor: Color(0xFF6F35A5),
                              ...
                              onChanged: (newValue) {
                                setState(() {
                                  ...
                                  if (autoFillOffice) {
                                    ...
                                    city1Controller.text = cityController.text;
                        ...
                        CheckboxListTile(
                          ...
                          value: nightStartTime != null && nightEndTime != null,
                          onChanged: (value) {
                            setState(() {
                              if (value!) {
                        ...
                        Visibility(
                          ...
                          child:
                              CoachingForm(), // Display the fields when 'Coaching' is selected
                        ),
                        //   Visibility(
                        //     visible: selectedclass == 'Karate ',
                        //     child:
                        //         //karate(), // Display the fields when 'Coaching' is selected
                        // //  ),
                        Padding(
                          padding: EdgeInsets.symmetric(
                            vertical: 1.h,
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                if (selectedclass == 'Coaching ') {
                                  Navigator.pushNamed(
                                      context, MyRoutes.coachingRoute);
                                } else if (selectedclass == 'Dance ') {
                                  Navigator.pushNamed(
                                      context, MyRoutes.danceRoute);
                                } else if (selectedclass == 'Karate ') {
                                  Navigator.pushNamed(
                                      context, MyRoutes.karateRoute);
                                } else if (selectedclass == 'Painting ') {
                                  Navigator.pushNamed(
                                      context, MyRoutes.paintingRoute);
                                }
                              }
                            },
