...
class _StudentPageState extends State<StudentPage> {
  ...
  void _navigateToNextScreen() {
    ...
    Navigator.pushReplacementNamed(context,MyRoutes.otpgeneratorRoute);
  }
                    ...
                    title: Column(
                      ...
                      children: [
                        CSCPicker(
                          ...
                          showStates: true,
                          showCities: true,
                          selectedItemStyle: GoogleFonts.baskervville(fontSize: fontSize ),
                        ),
                        if (cscPickerError != null)
                          Text(
                            cscPickerError!,
                            style :GoogleFonts.baskervville(color: Colors.red),
                          ),
                      ],
                    ),
                  ),
